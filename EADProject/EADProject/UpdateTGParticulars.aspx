<%@ Page Title="" Language="C#" MasterPageFile="~/navbarV2.Master" AutoEventWireup="true" CodeBehind="UpdateTGParticulars.aspx.cs" Inherits="EADProject.UpdateTGParticulars" %>
        ...
        <form runat="server">
            <div class="card-body">
                <div class="card-group">
                    ...
                    <asp:TextBox runat="server"> Robert Han </asp:TextBox>
                </div>
                <br />
                <div class="card-group">
                    <label class="col-1"> Email: </label>
                    <asp:TextBox runat="server"> Rob321@gmail.com </asp:TextBox>
                </div>
               <br />
                <div class="card-group">
                    ...
                    <asp:TextBox runat="server"> 9123 7845 </asp:TextBox>
                </div>
                <br />
                <div class="card-group">
