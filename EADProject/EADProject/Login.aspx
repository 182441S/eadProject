        ...
        <div class="col-md-4">
                <div class="login-dark p-3 shadow-lg rounded">
                    <div class="pt-3">
                        ...
                        <form class="mt-5" runat="server">
                            <div class="form-group">
                                <asp:TextBox ID="EmailID" runat="server" type="email" placeholder="Email" CssClass="form-control form-control-sm bg-light"/>
                            </div>

                            <div class="form-group">
                                <asp:TextBox ID="Password" runat="server" placeholder="Password" type="password" CssClass="form-control form-control-sm bg-light" />
                            </div>
                            ...
                            <div class="mt-5">
                                <asp:Button runat="server" ID="LoginBtn" Text="Login" OnClick="LoginBtn_Click" CssClass="btn btn-light col"></asp:Button>
                            </div>
                            ...
                            <div class="mt-5">
                                <p class="text-white text-center">
                                    ...
                                    <a href="Register1.aspx" class="text-warning">Click here to register</a>
                                </p>
                                <p class="text-white text-center">
